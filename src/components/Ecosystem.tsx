                  ...
                  {module.iconType === 'svg' ? (
                    <div className="w-20 h-20 lg:w-24 lg:h-24 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                      ...
                      {module.title === 'Socwritic' && (
                        <svg width="100%" height="100%" viewBox="3700 1900 3000 2800" className="filter brightness-110">
                          <g transform="matrix(5.55556,0,0,5.55556,0,0)">
                      ...
                      {module.title === 'Certainty' && (
                        <svg width="100%" height="100%" viewBox="1800 3800 3000 3000" className="filter brightness-110">
                          <g transform="matrix(5.55556,0,0,5.55556,0,0)">
